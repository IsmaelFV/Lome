...
class InventoryPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: LomeAppBar(title: context.l10n.inventoryTitle, showBack: false, useGradient: true),
      body: Column(
        children: [
          Padding(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return _InventoryItemCard(
                        item: item,
                        onTap: () => _showItemDialog(context, ref, item: item),
                        onAdjustStock: () =>
  ...
  void _showItemDialog(
    ...
    final minStockCtrl =
        TextEditingController(text: item?.minimumStock.toString() ?? '0');
